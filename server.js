...
const PERMIT_FIELD_SCHEMAS = {
  [PERMIT_TYPES.GENERAL_WORK_SAFE]: [
    ...
    { key: 'personnel_trained_protocols', label: 'Personnel trained in on-site safety protocols', type: 'checkbox', section: 'Section 4 – Hazard Communication & Worksite Safety' },
    { key: 'personnel_briefed_hazards', label: 'Personnel briefed on area hazards', type: 'checkbox', section: 'Section 4 – Hazard Communication & Worksite Safety' },
    { key: 'needs_shutdown', label: 'Equipment/process needs shutdown', type: 'checkbox', section: 'Section 4 – Hazard Communication & Worksite Safety' },
    { key: 'chemicals_cleared', label: 'Chemicals in work area cleared', type: 'checkbox', section: 'Section 4 – Hazard Communication & Worksite Safety' },
